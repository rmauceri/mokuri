    ...
    carveLevels: [
      {
        name: 'block',
        paths: [
          { d: 'M8,88 Q30,82 58,72 Q86,62 112,58 Q138,56 162,62 Q180,68 194,78', type: 'stroke', zone: 'branch', strokeWidth: 5 },
          { d: 'M58,72 Q52,58 48,44', type: 'stroke', zone: 'branch', strokeWidth: 2.5 },
          { d: 'M112,58 Q118,42 124,28', type: 'stroke', zone: 'branch', strokeWidth: 2.5 },
          { d: 'M162,62 Q170,48 178,36', type: 'stroke', zone: 'branch', strokeWidth: 2 },
          { d: 'M30,48 Q36,36 42,30 L46,26 Q42,22 38,24 L34,20 Q38,16 42,18 L44,14 Q48,10 50,16 L54,18 Q56,14 52,12 L58,14 Q60,20 56,24 L52,30 Q48,36 42,44 Z', type: 'fill', zone: 'leaf' },
          { d: 'M72,38 Q78,26 84,20 L88,16 Q84,12 80,14 L76,10 Q80,6 84,8 L86,4 Q90,0 92,6 L96,8 Q98,4 94,2 L100,4 Q102,10 98,14 L94,20 Q90,26 84,34 Z', type: 'fill', zone: 'leaf' },
          { d: 'M106,34 Q112,22 118,16 L122,12 Q118,8 114,10 L110,6 Q114,2 118,4 L120,0 Q124,0 126,4 L130,6 Q132,2 128,0 L134,2 Q136,8 132,12 L128,18 Q124,24 118,32 Z', type: 'fill', zone: 'leaf' },
          { d: 'M140,42 Q146,30 152,24 L156,20 Q152,16 148,18 L144,14 Q148,10 152,12 L154,8 Q158,4 160,10 L164,12 Q166,8 162,6 L168,8 Q170,14 166,18 L162,24 Q158,30 152,38 Z', type: 'fill', zone: 'leaf' },
          { d: 'M166,42 Q172,30 178,24 L182,20 Q178,16 174,18 L170,14 Q174,10 178,12 L180,8 Q184,6 186,12 L190,14 Q192,10 188,8 L194,10 Q196,16 192,20 L188,26 Q184,32 178,40 Z', type: 'fill', zone: 'leaf' },
          { d: 'M86,66 Q92,54 98,48 L102,44 Q98,40 94,42 L90,38 Q94,34 98,36 L100,32 Q104,28 106,34 L110,36 Q112,32 108,30 L114,32 Q116,38 112,42 L108,48 Q104,54 98,62 Z', type: 'fill', zone: 'leaf' },
          { d: 'M138,72 Q144,60 150,54 L154,50 Q150,46 146,48 L142,44 Q146,40 150,42 L152,38 Q156,34 158,40 L162,42 Q164,38 160,36 L166,38 Q168,44 164,48 L160,54 Q156,60 150,68 Z', type: 'fill', zone: 'leaf' }
        ]
      },
      {
        name: 'shape',
        paths: [
          ...
          { d: 'M86,66 Q92,54 98,48 L102,44 Q98,40 94,42 L90,38 Q94,34 98,36 L100,32 Q104,28 106,34 L110,36 Q112,32 108,30 L114,32 Q116,38 112,42 L108,48 Q104,54 98,62 Z', type: 'fill', zone: 'leaf' },
          { d: 'M138,72 Q144,60 150,54 L154,50 Q150,46 146,48 L142,44 Q146,40 150,42 L152,38 Q156,34 158,40 L162,42 Q164,38 160,36 L166,38 Q168,44 164,48 L160,54 Q156,60 150,68 Z', type: 'fill', zone: 'leaf' },
          { d: 'M30,48 Q36,36 42,30 L46,26 Q42,22 38,24 L34,20 Q38,16 42,18 L44,14 Q48,10 50,16 L54,18 Q56,14 52,12 L58,14 Q60,20 56,24 L52,30 Q48,36 42,44 Z', type: 'stroke', zone: 'leaf', strokeWidth: 0.8 },
          { d: 'M72,38 Q78,26 84,20 L88,16 Q84,12 80,14 L76,10 Q80,6 84,8 L86,4 Q90,0 92,6 L96,8 Q98,4 94,2 L100,4 Q102,10 98,14 L94,20 Q90,26 84,34 Z', type: 'stroke', zone: 'leaf', strokeWidth: 0.8 },
          { d: 'M106,34 Q112,22 118,16 L122,12 Q118,8 114,10 L110,6 Q114,2 118,4 L120,0 Q124,0 126,4 L130,6 Q132,2 128,0 L134,2 Q136,8 132,12 L128,18 Q124,24 118,32 Z', type: 'stroke', zone: 'leaf', strokeWidth: 0.8 },
          { d: 'M140,42 Q146,30 152,24 L156,20 Q152,16 148,18 L144,14 Q148,10 152,12 L154,8 Q158,4 160,10 L164,12 Q166,8 162,6 L168,8 Q170,14 166,18 L162,24 Q158,30 152,38 Z', type: 'stroke', zone: 'leaf', strokeWidth: 0.8 },
          { d: 'M166,42 Q172,30 178,24 L182,20 Q178,16 174,18 L170,14 Q174,10 178,12 L180,8 Q184,6 186,12 L190,14 Q192,10 188,8 L194,10 Q196,16 192,20 L188,26 Q184,32 178,40 Z', type: 'stroke', zone: 'leaf', strokeWidth: 0.8 }
        ]
      },
      {
        name: 'detail',
        paths: [
          ...
          { d: 'M86,66 Q92,54 98,48 L102,44 Q98,40 94,42 L90,38 Q94,34 98,36 L100,32 Q104,28 106,34 L110,36 Q112,32 108,30 L114,32 Q116,38 112,42 L108,48 Q104,54 98,62 Z', type: 'fill', zone: 'leaf' },
          { d: 'M138,72 Q144,60 150,54 L154,50 Q150,46 146,48 L142,44 Q146,40 150,42 L152,38 Q156,34 158,40 L162,42 Q164,38 160,36 L166,38 Q168,44 164,48 L160,54 Q156,60 150,68 Z', type: 'fill', zone: 'leaf' },
          { d: 'M44,30 L38,42', type: 'stroke', zone: 'detail', strokeWidth: 0.5 },
          { d: 'M42,26 L48,38', type: 'stroke', zone: 'detail', strokeWidth: 0.4 },
          { d: 'M86,20 L80,32', type: 'stroke', zone: 'detail', strokeWidth: 0.5 },
          { d: 'M84,16 L90,28', type: 'stroke', zone: 'detail', strokeWidth: 0.4 },
          { d: 'M120,16 L114,28', type: 'stroke', zone: 'detail', strokeWidth: 0.5 },
          { d: 'M118,12 L124,24', type: 'stroke', zone: 'detail', strokeWidth: 0.4 },
          { d: 'M154,24 L148,36', type: 'stroke', zone: 'detail', strokeWidth: 0.5 },
          { d: 'M152,20 L158,32', type: 'stroke', zone: 'detail', strokeWidth: 0.4 },
          { d: 'M180,24 L174,36', type: 'stroke', zone: 'detail', strokeWidth: 0.5 },
          { d: 'M178,20 L184,32', type: 'stroke', zone: 'detail', strokeWidth: 0.4 },
          { d: 'M100,48 L94,58', type: 'stroke', zone: 'detail', strokeWidth: 0.5 },
          { d: 'M152,54 L146,64', type: 'stroke', zone: 'detail', strokeWidth: 0.5 },
          { d: 'M20,86 Q28,84 36,86', type: 'stroke', zone: 'detail', strokeWidth: 0.4 },
          { d: 'M68,72 Q76,68 84,70', type: 'stroke', zone: 'detail', strokeWidth: 0.4 }
        ]
      }
    ]
  },

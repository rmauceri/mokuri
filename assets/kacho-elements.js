    ...
    carveLevels: [
      {
        ...
        paths: [
          ...
          { d: 'M44 44 Q36 26 50 8 L52 2 L54 8 Q68 26 60 44 Z', type: 'fill', zone: 'petal' },
          { d: 'M38 46 Q26 34 28 14 L30 6 L34 14 Q36 32 48 44 Z', type: 'fill', zone: 'petal' },
          { d: 'M56 44 Q68 32 70 14 L74 6 L74 14 Q78 34 66 46 Z', type: 'fill', zone: 'petal' },
          { d: 'M32 50 Q18 42 12 28 L8 20 L14 26 Q24 40 42 48 Z', type: 'fill', zone: 'petal' },
          { d: 'M62 48 Q80 40 92 28 L96 20 L90 26 Q80 42 72 50 Z', type: 'fill', zone: 'petal' },
          { d: 'M30 54 Q14 50 6 40 L2 34 L8 38 Q18 48 38 52 Z', type: 'fill', zone: 'petal' },
          { d: 'M66 52 Q86 50 98 40 L102 34 L96 38 Q86 48 74 54 Z', type: 'fill', zone: 'petal' },
          // Middle row (5 petals, shorter, filling gaps between back row)
          { d: 'M46 44 Q42 32 50 14 L52 8 L54 14 Q62 32 58 44 Z', type: 'fill', zone: 'petal' },
          { d: 'M38 48 Q28 40 24 28 L22 22 L28 26 Q34 38 46 46 Z', type: 'fill', zone: 'petal' },
          { d: 'M58 46 Q70 38 80 28 L82 22 L76 26 Q70 40 66 48 Z', type: 'fill', zone: 'petal' },
          { d: 'M34 52 Q22 48 14 40 L10 34 L16 38 Q26 48 42 50 Z', type: 'fill', zone: 'petal' },
          { d: 'M62 50 Q82 48 90 40 L94 34 L88 38 Q78 48 72 52 Z', type: 'fill', zone: 'petal' },
          // Golden center
          { d: 'M44 50 Q48 44 56 44 Q62 48 60 54 Q56 58 50 56 Q42 54 44 50 Z', type: 'fill', zone: 'center' },
          // === Small bloom (right) — 5 wider sharp petals, tightly packed ===
          { d: 'M126 52 Q124 40 130 26 L132 18 L134 26 Q140 40 138 52 Z', type: 'fill', zone: 'petal' },
          { d: 'M120 56 Q110 52 104 44 L100 38 L106 42 Q114 50 126 54 Z', type: 'fill', zone: 'petal' },
          { d: 'M138 54 Q150 50 160 44 L164 38 L158 42 Q150 52 144 56 Z', type: 'fill', zone: 'petal' },
          { d: 'M124 54 Q118 44 122 32 L124 24 L128 32 Q132 44 130 52 Z', type: 'fill', zone: 'petal' },
          { d: 'M134 52 Q146 44 142 32 L140 24 L136 32 Q132 44 140 54 Z', type: 'fill', zone: 'petal' },
          { d: 'M124 58 Q128 54 136 54 Q142 58 140 62 Q136 64 132 62 Q124 60 124 58 Z', type: 'fill', zone: 'center' },
          // === 3 Lily pads ===
          ...
          // === Short slim stems ===
          { d: 'M50 56 Q48 68 48 80 Q46 90 48 98 L52 98 Q54 90 52 80 Q52 68 54 56 Z', type: 'fill', zone: 'stem' },
          { d: 'M130 62 Q128 72 128 84 Q126 94 128 102 L132 102 Q134 94 132 84 Q132 72 134 62 Z', type: 'fill', zone: 'stem' },
        ],
      },
      {
        name: 'shape',
        paths: [
          ...
          { d: 'M44 44 Q36 26 50 8 L52 2 M60 44 Q68 26 54 8 L52 2', type: 'stroke', zone: 'petal', strokeWidth: 0.8 },
          { d: 'M38 46 Q26 34 28 14 L30 6 M66 46 Q78 34 74 14 L74 6', type: 'stroke', zone: 'petal', strokeWidth: 0.6 },
          { d: 'M32 50 Q18 42 12 28 L8 20 M72 50 Q86 42 92 28 L96 20', type: 'stroke', zone: 'petal', strokeWidth: 0.6 },
      ...
      },
      {
        ...
        paths: [
          ...
          { d: 'M52 42 Q48 26 52 6 M43 44 Q30 34 30 12 M61 44 Q74 34 74 12', type: 'stroke', zone: 'petal', strokeWidth: 0.3 },
          { d: 'M36 48 Q22 42 12 26 M68 48 Q82 42 92 26', type: 'stroke', zone: 'petal', strokeWidth: 0.3 },
          { d: 'M34 52 Q18 50 8 40 M70 52 Q86 50 96 40', type: 'stroke', zone: 'petal', strokeWidth: 0.3 },
          // Detail — center stamens
          { d: 'M48 50 L46 46 M52 48 L52 44 M56 50 L58 46 M50 54 L48 56', type: 'stroke', zone: 'center', strokeWidth: 0.4 },
          // Detail — small bloom petal veins
          { d: 'M132 48 Q130 38 132 24 M124 54 Q114 50 106 42 M140 54 Q152 50 160 42', type: 'stroke', zone: 'petal', strokeWidth: 0.3 },
          ...
          // Stem fiber
          { d: 'M50 66 Q48 76 48 88 M130 70 Q128 80 128 92', type: 'stroke', zone: 'stem', strokeWidth: 0.3 },
        ],
      },
    ],
  },

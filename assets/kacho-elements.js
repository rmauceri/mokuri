...
const MOKURI_KACHOE_ELEMENTS = [
  ...
  // Lotus Cluster — 2 lotus blossoms (wide-base sharp-tipped packed petals) on short stems, 3 lily pads
  {
    id: 'lotus-cluster',
    name: 'Lotus Cluster',
    category: 'flora',
    ...
    carveLevels: [
      {
        name: 'block',
        paths: [
          // === Large bloom — wide-base, sharp-tipped, tightly packed petals ===
          // Back row (7 petals, tallest, overlapping at base for full coverage)
          { d: 'M44 74 Q36 56 50 38 L52 32 L54 38 Q68 56 60 74 Z', type: 'fill', zone: 'petal' },
          { d: 'M38 76 Q26 64 28 44 L30 36 L34 44 Q36 62 48 74 Z', type: 'fill', zone: 'petal' },
          { d: 'M56 74 Q68 62 70 44 L74 36 L74 44 Q78 64 66 76 Z', type: 'fill', zone: 'petal' },
          { d: 'M32 80 Q18 72 12 58 L8 50 L14 56 Q24 70 42 78 Z', type: 'fill', zone: 'petal' },
          { d: 'M62 78 Q80 70 92 58 L96 50 L90 56 Q80 72 72 80 Z', type: 'fill', zone: 'petal' },
          { d: 'M30 84 Q14 80 6 70 L2 64 L8 68 Q18 78 38 82 Z', type: 'fill', zone: 'petal' },
          { d: 'M66 82 Q86 80 98 70 L102 64 L96 68 Q86 78 74 84 Z', type: 'fill', zone: 'petal' },
          // Middle row (5 petals, shorter, filling gaps between back row)
          { d: 'M46 74 Q42 62 50 44 L52 38 L54 44 Q62 62 58 74 Z', type: 'fill', zone: 'petal' },
          { d: 'M38 78 Q28 70 24 58 L22 52 L28 56 Q34 68 46 76 Z', type: 'fill', zone: 'petal' },
          { d: 'M58 76 Q70 68 80 58 L82 52 L76 56 Q70 70 66 78 Z', type: 'fill', zone: 'petal' },
          { d: 'M34 82 Q22 78 14 70 L10 64 L16 68 Q26 78 42 80 Z', type: 'fill', zone: 'petal' },
          { d: 'M62 80 Q82 78 90 70 L94 64 L88 68 Q78 78 72 82 Z', type: 'fill', zone: 'petal' },
          // Golden center
          { d: 'M44 80 Q48 74 56 74 Q62 78 60 84 Q56 88 50 86 Q42 84 44 80 Z', type: 'fill', zone: 'center' },
          // === Small bloom (right) — 5 wider sharp petals, tightly packed ===
          { d: 'M126 79 Q124 67 130 53 L132 45 L134 53 Q140 67 138 79 Z', type: 'fill', zone: 'petal' },
          { d: 'M120 83 Q110 79 104 71 L100 65 L106 69 Q114 77 126 81 Z', type: 'fill', zone: 'petal' },
          { d: 'M138 81 Q150 77 160 71 L164 65 L158 69 Q150 79 144 83 Z', type: 'fill', zone: 'petal' },
          { d: 'M124 81 Q118 71 122 59 L124 51 L128 59 Q132 71 130 79 Z', type: 'fill', zone: 'petal' },
          { d: 'M134 79 Q146 71 142 59 L140 51 L136 59 Q132 71 140 81 Z', type: 'fill', zone: 'petal' },
          { d: 'M124 85 Q128 81 136 81 Q142 85 140 89 Q136 91 132 89 Q124 87 124 85 Z', type: 'fill', zone: 'center' },
          // === 3 Lily pads ===
          { d: 'M56 100 Q28 96 16 108 Q8 120 20 132 Q32 140 56 140 Q80 140 92 132 Q104 120 96 108 Q84 96 56 100 Z', type: 'fill', zone: 'pad' },
          { d: 'M130 101 Q110 98 100 111 Q95 121 105 131 Q115 136 135 136 Q153 133 158 123 Q160 111 150 103 Q140 98 130 101 Z', type: 'fill', zone: 'pad' },
          { d: 'M153 84 Q143 82 138 89 Q135 97 140 102 Q148 104 155 102 Q160 97 160 89 Q158 84 153 84 Z', type: 'fill', zone: 'pad' },
          // === Short slim stems ===
          { d: 'M50 86 Q48 90 48 94 Q47 96 48 98 L52 98 Q53 96 52 94 Q52 90 54 86 Z', type: 'fill', zone: 'stem' },
          { d: 'M130 89 Q128 93 128 98 Q127 100 128 102 L132 102 Q133 100 132 98 Q132 93 134 89 Z', type: 'fill', zone: 'stem' },
        ],
      },
      {
        name: 'shape',
        paths: [
          ...
          { d: 'M44 74 Q36 56 50 38 L52 32 M60 74 Q68 56 54 38 L52 32', type: 'stroke', zone: 'petal', strokeWidth: 0.8 },
          { d: 'M38 76 Q26 64 28 44 L30 36 M66 76 Q78 64 74 44 L74 36', type: 'stroke', zone: 'petal', strokeWidth: 0.6 },
          { d: 'M32 80 Q18 72 12 58 L8 50 M72 80 Q86 72 92 58 L96 50', type: 'stroke', zone: 'petal', strokeWidth: 0.6 },
          ...
          // Medium pad V-notch
          { d: 'M130 101 L128 118 M130 101 L133 118', type: 'stroke', zone: 'pad', strokeWidth: 0.8 },
          // Small pad V-notch
          { d: 'M153 84 L150 94 M153 84 L155 94', type: 'stroke', zone: 'pad', strokeWidth: 0.6 },
        ],
      },
      {
        name: 'detail',
        paths: [
          ...
          { d: 'M52 72 Q48 56 52 36 M43 74 Q30 64 30 42 M61 74 Q74 64 74 42', type: 'stroke', zone: 'petal', strokeWidth: 0.3 },
          { d: 'M36 78 Q22 72 12 56 M68 78 Q82 72 92 56', type: 'stroke', zone: 'petal', strokeWidth: 0.3 },
          { d: 'M34 82 Q18 80 8 70 M70 82 Q86 80 96 70', type: 'stroke', zone: 'petal', strokeWidth: 0.3 },
          // Detail — center stamens
          { d: 'M48 80 L46 76 M52 78 L52 74 M56 80 L58 76 M50 84 L48 86', type: 'stroke', zone: 'center', strokeWidth: 0.4 },
          // Detail — small bloom petal veins
          { d: 'M132 75 Q130 65 132 51 M124 81 Q114 77 106 69 M140 81 Q152 77 160 69', type: 'stroke', zone: 'petal', strokeWidth: 0.3 },
          ...
          // Medium pad veins
          { d: 'M130 118 L115 131 M130 118 L145 131 M130 118 L110 111 M130 118 L150 111', type: 'stroke', zone: 'pad', strokeWidth: 0.3 },
          // Small pad veins
          { d: 'M150 94 L145 99 M150 94 L155 99', type: 'stroke', zone: 'pad', strokeWidth: 0.3 },
          // Stem fiber
          { d: 'M50 88 Q48 92 48 96 M130 92 Q128 96 128 100', type: 'stroke', zone: 'stem', strokeWidth: 0.3 },
        ],
      },
    ],
  },
  ...
  // Lily Pad — single floating pad, rotated angle, V-notch and radial veins
  {
    id: 'lily-pad',
    name: 'Lily Pad',
    category: 'flora',
    ...
    carveLevels: [
      {
        name: 'block',
        paths: [
          // Broad elliptical pad, angled so notch faces upper-right
          { d: 'M54 8 Q78 4 92 18 Q100 32 94 50 Q86 66 64 72 Q40 76 22 66 Q6 54 4 38 Q4 22 18 12 Q32 4 54 8 Z', type: 'fill', zone: 'pad' },
        ],
      },
      {
        name: 'shape',
        paths: [
          { d: 'M54 8 Q78 4 92 18 Q100 32 94 50 Q86 66 64 72 Q40 76 22 66 Q6 54 4 38 Q4 22 18 12 Q32 4 54 8 Z', type: 'fill', zone: 'pad' },
          // Pad outline
          { d: 'M54 8 Q78 4 92 18 Q100 32 94 50 Q86 66 64 72 Q40 76 22 66 Q6 54 4 38 Q4 22 18 12 Q32 4 54 8', type: 'stroke', zone: 'pad', strokeWidth: 0.8 },
          // V-notch opening toward upper-right
          { d: 'M54 8 L52 36 M54 8 L60 34', type: 'stroke', zone: 'pad', strokeWidth: 1.0 },
          // Center point reference for veins
          { d: 'M50 40 L34 58 M50 40 L68 56 M50 40 L26 34 M50 40 L76 34', type: 'stroke', zone: 'pad', strokeWidth: 0.6 },
        ],
      },
      {
        name: 'detail',
        paths: [
          ...
          { d: 'M54 8 L52 36 M54 8 L60 34', type: 'stroke', zone: 'pad', strokeWidth: 1.0 },
          { d: 'M50 40 L34 58 M50 40 L68 56 M50 40 L26 34 M50 40 L76 34', type: 'stroke', zone: 'pad', strokeWidth: 0.6 },
          // Full radial veins from center
          { d: 'M50 40 L20 52 M50 40 L78 46 M50 40 L42 68 M50 40 L62 66 M50 40 L14 28 M50 40 L84 24', type: 'stroke', zone: 'pad', strokeWidth: 0.4 },
          // Fine vein texture between main veins
          { d: 'M50 40 L30 46 M50 40 L72 50 M50 40 L36 22 M50 40 L66 20', type: 'stroke', zone: 'detail', strokeWidth: 0.25 },
          // Subtle surface dimple at center
          { d: 'M48 38 Q50 36 52 38 Q54 40 52 42 Q50 44 48 42 Q46 40 48 38 Z', type: 'stroke', zone: 'detail', strokeWidth: 0.3 },
        ],
      },
    ],
  },

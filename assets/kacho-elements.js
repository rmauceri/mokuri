    ...
    carveLevels: [
      {
        ...
        paths: [
          ...
          { d: 'M2 26 L22 18 L22 30 Z', type: 'fill', zone: 'detail' },
          // Folded wing
      ...
      },
      {
        ...
        paths: [
          ...
          // Beak ridge
          { d: 'M2 26 L22 24', type: 'stroke', zone: 'detail', strokeWidth: 0.6 },
          // Foot toes
    ...
    carveLevels: [
      {
        ...
        paths: [
          ...
          // Beak: long sharp, accent color (yellow for egret)
          { d: 'M4 24 L24 16 L24 28 Z', type: 'fill', zone: 'accent' },
      ...
      },
      {
        ...
        paths: [
          ...
          // Beak ridge
          { d: 'M4 24 L24 22', type: 'stroke', zone: 'accent', strokeWidth: 0.5 },
          // Foot toes
